...
(
	...
	'row_users_ips' => "IP记录",
	'row_ip_history' => "IP历史",
	'text_user_earlier_used' => "该用户曾使用",
	'text_different_ips' => "个不同的IP登录",
	'row_ip_address' => "当前IP",
	'row_bt_client' => "BT客户端",
	'row_uploaded' => "上传量",
	'row_downloaded' => "下载量",
	...
	'radio_no' => "否",
	'row_support' => "一线客服",
	'row_support_language' => "使用语言",
	'row_support_for' => "服务范围",
	'row_comment' => "备注",
	'row_seeding_karma' => "麦粒",
	...
	'row_vip_by_bonus' => "贵宾资格为通过麦粒获得",
	'text_vip_by_bonus_note' => "该贵宾资格是否为通过麦粒换取。",
	'row_vip_until' => "贵宾资格结束时间",
	'text_vip_until_note' => "时间格式为'年年年年-月月-日日 时时:分分:秒秒'。贵宾资格结束的时间。'贵宾资格为通过麦粒获得'必须设为'是'此规则才能生效。",
	'row_show_ad' => "显示广告",
