...
(
	...
	'head_save_bonus_settings' => "儲存麥粒設定",
	...
	'row_kps_enabled' => "開啟麥粒系統",
	'text_enabled' => "開啟",
	'text_disabled_but_save' => "關閉但仍記錄數值",
	'text_disabled_no_save' => "完全關閉",
	'text_kps_note' => "預設‘開啟’。開啟或關閉麥粒系統，是否記錄數值。",
	...
	'text_general_profile_management_note' => "。改變用戶的基本檔案，但無法改變其中重要的項目，如郵箱位址、用戶名、上傳量、下載量、麥粒數。",
	...
	'text_buy_invites_note' => "。允許在麥粒中心購買邀請。",
	...
	'head_bonus_settings' => "麥粒設定",
	'text_bonus_by_seeding' => "做種獲得麥粒",
	'row_donor_gets_double' => "捐贈者加倍",
	'text_donor_gets' => "捐贈者通過做種能獲得正常情況",
	'text_times_as_many' => "倍的麥粒。預設'2'。設為'0'則將捐贈者和其他用戶同等對待。",
	'row_basic_seeding_bonus' => "基礎做種麥粒",
	'text_user_would_get' => "對于每個做種中的種子，用戶將獲得",
	'text_bonus_points' => "個麥粒，最多計算",
	'text_torrents_default' => "個種子。預設'1'，'7'。將麥粒數設為'0'來禁止此規則。",
	'row_seeding_formula' => "做種公式",
	'text_bonus_formula_one' => "每小時獲得的麥粒點數由下面的公式給出",
	'text_where' => "式中",
	...
	'text_bonus_formula_eight' => "<b>B</b>為1小時中用戶獲得的做種麥粒點數",
	'text_bonus_formula_nine' => "<b>B0</b>為參數，代表用戶1小時獲得麥粒的上限。<b>B0</b> = ",
	...
	'text_uploading_torrent_note' => "個麥粒，如果他發布一個新種子。預設'15'。",
	'row_uploading_subtitle' => "上傳一個字幕",
	'text_uploading_subtitle_note' => "個麥粒，如果他上傳一個字幕。預設'5'。",
	'row_starting_topic' => "發布新主題",
	'text_starting_topic_note' => "個麥粒，如果他在論壇發布一個新的主題。預設'2'。",
	'row_making_post' => "回覆帖子",
	'text_making_post_note' => "個麥粒，如果他在論壇發布一個帖子。預設'1'。",
	'row_adding_comment' => "發布評論",
	'text_adding_comment_note' => "個麥粒，如果他對種子、候選發表了一次評論。預設'1'。",
	'row_voting_on_poll' => "參與調查投票",
	'text_voting_on_poll_note' => "個麥粒，如果他參與一次調查投票。預設'1'。",
	'row_voting_on_offer' => "參與候選投票",
	'text_voting_on_offer_note' => "個麥粒，如果他參與一次候選投票。預設'1'。",
	'row_voting_on_funbox' => "趣味盒投票",
	'text_voting_on_funbox_note' => "個麥粒，如果他參與一次趣味盒投票。預設'1'。",
	'row_saying_thanks' => "說謝謝",
	'text_giver_and_receiver_get' => "感謝表達者和接受者將分別得到",
	'text_saying_thanks_and' => "和",
	'text_saying_thanks_default' => "個麥粒。預設'0.5'，'0'。",
	'row_funbox_stuff_reward' => "趣味盒獎勵",
	'text_funbox_stuff_reward_note' => "個麥粒，如果他發布的趣味盒內容被評為“有趣”。預設'5'。",
	'text_things_cost_bonus' => "消耗麥粒的項目",
	'row_one_gb_credit' => "1.0 GB上傳量",
	'text_it_costs_user' => "用戶將失去",
	'text_one_gb_credit_note' => "個麥粒，如果他選取交換1.0 GB上傳量。預設'300'。",
	'row_five_gb_credit' => "5.0 GB上傳量",
	'text_five_gb_credit_note' => "個麥粒，如果他選取交換5.0 GB上傳量。預設'800'。",
	'row_ten_gb_credit' => "10.0 GB上傳量",
	'text_ten_gb_credit_note' => "個麥粒，如果他選取交換5.0 GB上傳量。預設'1200'。",
	...
	'text_buy_an_invite_note' => "個麥粒，如果他選取交換一個邀請名額。預設'1000'。",

	'row_custom_title' => "自訂頭銜",
	'text_custom_title_note' => "個麥粒，如果他選取自訂一次頭銜。預設'5000'。",
	'row_vip_status' => "貴賓待遇",
	'text_vip_status_note' => "個麥粒，如果他選取給自己換取一個月的貴賓待遇。預設'8000'。",
	'row_allow_giving_bonus_gift' => "允許麥粒贈送",
	'text_giving_bonus_gift_note' => "允許用戶間相互贈送麥粒。預設'是'。",
	...
	'text_cleanup_interval_note_one' => "每XXX秒時間做自動清理工作（用戶升級、降級、添加做種麥粒等）。",
	'text_priority_one' => "優先級1：",
	'text_priority_one_note' => "更新同伴狀態；添加做種麥粒。預設'900'，即15分鐘。",
	...
	'row_bonus_settings' => "麥粒設定",
	'submit_bonus_settings' => "麥粒設定",
	'text_bonus_settings_note' => "配置麥粒的抓取和使用。",
	...
	'row_bonus_gift_tax' => "麥粒贈送稅收",
	'text_system_charges' => "系統向禮物接收者索取",
	'text_bonus_points_plus' => "個麥粒 + 贈送額的",
	'text_bonus_gift_tax_note' => "%的麥粒作為稅收。如設為'5'，'10'時，禮物贈送者傳送100個麥粒，接收者只獲得85個。預設'5'，'10'。<br /><b>注意</b>：兩條規則是分開執行的，將兩個值都設為'0'才能完全免除稅收。",
	...
	'row_bonus_no_advertisement' => "麥粒交換可關閉廣告",
	'text_no_advertisement_with_bonus' => "及以上等級用戶可用麥粒換取一定期限內不察看廣告的許可權。預設",
	'row_no_advertisement_bonus_price' => "無廣告麥粒",
	'text_bonus_points_to_buy' => "個麥粒，如果他選取交換",
	'text_days_without_advertisements' => "天不察看廣告的許可權。預設'10000'，'15'。",
	'row_click_advertisement_bonus' => "點擊廣告抓取麥粒",
	'text_points_clicking_on_advertisements' => "個麥粒，如果他第一次點擊某個廣告。設為'0'來禁用此規則。<br /><b>注意</b>：一些廣告服務（如Google Adsense）禁止網站激勵用戶點擊廣告的行為。",
	...
	'text_promotion_link_note_one' => "個麥粒，如果他的宣傳鏈結獲得一次來自一個未記錄的IP的點擊。",
	'text_promotion_link_note_two' => "秒內最多獎勵一次點擊。將麥粒設為'0'來禁用宣傳鏈結功能。預設'0'，'600'。",
