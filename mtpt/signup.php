...
<td><input type="text" name="invitenumber" size="30"></td></tr>
<tr><td colspan=2 align=right><input type=submit value=<?=$lang_signup['submit_invite']?>></td></tr>
</table>
</form>
<?	
	stdfoot();
...
?>
<tr><td class=rowhead width=80><?php echo $lang_signup['row_desired_username'] ?></td><td class=rowfollow align=left><input type="text" style="width: 200px" name="wantusername" /><br />
