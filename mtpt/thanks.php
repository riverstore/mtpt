...
$tsql = sql_query("SELECT COUNT(*) FROM thanks where torrentid=".sqlesc($torrentid)." and userid=$userid");
...
{
$res = sql_query("INSERT INTO thanks (torrentid, userid) VALUES (".sqlesc($torrentid).", $userid)");
