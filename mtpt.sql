...
(1, '添加用户', 'adduser.php', '添加一个新用户'),
(3, '重置用户密码', 'reset.php', '当用户申请密码搞忘时重置用户密码'),
(4, '全站发信', 'staffmess.php', '给全站用户发送站内信'),
(6, '查看投票', 'polloverview.php', '查看投票统计信息'),
(7, '被警告用户', 'warned.php', '查看被tracker警告过的用户'),
(8, '免费种子设定', 'freeleech.php', '设定种子为特殊状态'),
(9, 'FAQ 管理', 'faqmanage.php', '编辑FAQ 页面'),
(10, '规则管理', 'modrules.php', '编辑规则页面'),
(11, '分类管理', 'catmanage.php', '管理种子分类'),
(12, '用户搜索', 'searchuser.php', '用户搜索'),
(13, '删除搜索关键字', 'delkeywords.php', '删除用户搜索的关键字记录');
...
(16, 'uTorrent 1.83', '-UT183B-', 'uTorrent/183B(14809)', 'PTLiar use this agent.');
...
(2, 'Ktorrent 4.0.x', 'Ktorrent 4.0.x', '/^-KT4([0-9])([0-9])([0-9])-/', 0, 'dec', '-KT4000-', '/^KTorrent\\/4\\.([0-9])\\.([0-9])/', 0, 'dec', 'KTorrent/4.0.0', 'no', 'yes', '', 0),
...
(12, 'uTorrent 1.8.x', 'uTorrent 1.8.0', '/^-UT18([0-9])([0-9])-/', 2, 'dec', '-UT1800-', '/^uTorrent\\/18([0-9])([0-9])/', 2, 'dec', 'uTorrent/1800', 'no', 'yes', '', 148),
(13, 'Azureus 4.x', 'Vuze 4.0.0.2', '/^-AZ4([0-9])([0-9])([0-9])-/', 3, 'dec', '-AZ4002-', '/^Azureus 4\\.([0-9])\\.([0-9])\\.([0-9])/', 3, 'dec', 'Azureus 4.0.0.2', 'no', 'yes', '', 1),
...
(17, 'uTorrent 2.x.x', 'uTorrent 2.0(build 17624)', '/^-UT2([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT2000-', '/^uTorrent\\/2([0-9])([0-9])([0-9])/', 3, 'dec', 'uTorrent/2000', 'no', 'yes', '', 1743),
(19, 'uTorrent 3.x', 'uTorrent 3.0', '/^-UT3([0-9])([0-9])([0-9])-/', 3, 'dec', '-UT3000-', '/^uTorrent\\/3([0-9])([0-9])([0-9])/', 3, 'dec', 'uTorrent/3000', 'no', 'yes', '', 0),
(18, 'uTorrent 3.x.xB', 'uTorrent 3.0 Beta', '/^-UT3([0-9])([0-9])B-/', 2, 'dec', '-UT300B-', '/^uTorrent\\/3([0-9])([0-9])B/', 2, 'dec', 'uTorrent/300B', 'no', 'yes', '', 0);
...
('lastcleantime', '', 0, 1306512732),
('last24', '', 947, 1211708476),
('lastcleantime2', '', 0, 1306512732),
('lastcleantime3', '', 0, 1306509939),
('lastcleantime4', '', 0, 1306509939),
('lastcleantime5', '', 0, 1305870784);
...
(401, 4, 'c_movies', '电影', 'movies_dvdr.png', 0),
(402, 4, 'c_tvseries', '剧集', 'tvseries_xvid.png', 3),
(403, 4, 'c_tvshows', '综艺', 'tvshows.png', 4),
(404, 4, 'c_doc', '纪录片', 'doc.png', 1),
(405, 4, 'c_anime', '动漫', 'anime.png', 2),
(406, 4, 'c_mv', 'MV', 'musicvideos.png', 5),
(407, 4, 'c_sports', '体育', 'sports.png', 6),
(408, 4, 'c_hqaudio', '软件', 'appz.png', 9),
(409, 4, 'c_misc', '其他', 'misc.png', 17),
(410, 4, 'c_game', '游戏', 'games_pc.png', 10),
(411, 4, 'c_doucument', '学习', 'study.png', 16),
(412, 4, '', '掌机', 'games_handheld.png', 11),
(413, 4, '', '蓝光', 'movies_bd.png', 7),
(414, 4, '', '音乐', 'music.png', 8);
...
(1, '标准', 'scenetorrents/', 'pic/category/chd/scenetorrents/catsprites.css', 'yes', 'no', 'NexusPHP', 'Modified from SceneTorrents');
...
(10, 10, 25, 'item', '什么是PT？', 'PT（Private Tracker）下载其实也是BT下载的一种，在有限的范围内，下载的用户基本都可以达到自己带宽的上限。PT下载还通过论坛制度的约束机制将BT的设计理念现实化，真正让用户做到下载的过程中努力上传。因此，PT下载的速度很快，能够让用户带宽得到最大程度的使用，而且种子时效长。', 1, 1, 1),
...
(476, 12, 25, 'item', '为什么我的客户端无法下载本站资源？', '在网络通畅的前提下，若做种数为0则说明无人做种因此无法下载；若做种数非0还是无法下载说明你的客户端有问题，试试这个客户端吧！<a href=uTorrent221.zip>http://pt.nwsuaf6.edu.cn/uTorrent221.zip</a>（右键-“目标另存为”即可下载）。<br /><br />\r\n注意：下载完成后请 不要 立即关闭客户端，这样你在分享他人的资源时别人也可以分享你的资源，同时你的用户等级也会慢慢提升；反之，只知索取却不愿奉献，你将被自动降级直至无法下载任何资源。对待生活亦应如此。\r\n<br />\r\n<br />\r\n首先按照以下设置检查你的utorrent客户端是否设置正确：<br />\r\n<br />\r\n以utorrent2.2为例，打开选项---设置:<br /><br />\r\n\r\n1.注意关闭DHT、本地用户发现、用户交换等，只开启“向Tracker查询状态信息”，如图:<br />\r\n<img src="pic/utorrent_settings.png" alt="ratio" /><br />\r\n<br />\r\n选择: 向Tracker查询状态信息 和 允许传入旧式连接<br />\r\n\r\n传出连接 选择 启用<br />\r\n\r\n不选: 其他任何选择项<br />\r\n\r\n<br />\r\n2.队列设置<br />\r\n<img src="pic/utorrent_settings_3.png" alt="ratio" /><br /><br />\r\n\r\n3.“高级”设置中，修改 bt.scrape_stopped 为 false ，如图:<br />\r\n<img src="pic/utorrent_settings_4.png" alt="ratio" /><br /><br />\r\n\r\n4.“高级”设置中，修改 bt.transp_disposition 为 31 ，并点击“设置”按钮，如图：<br />\r\n<img src="pic/utorrent_settings_5.png" alt="ratio" /><br /><br />\r\n\r\n5.“高级”设置中，修改 diskio.coalesce_write_size 为 4194304 ，并点击“设置”按钮，如图：<br />\r\n<img src="pic/utorrent_settings_6.png" alt="ratio" /><br /><br />\r\n\r\n6.<font color=red>(重要)</font>“高级”设置中，修改 net.disable_ipv6 为 false ，如图：<br />\r\n（某些版本的μTorrent可能没有此设置，如果仔细检查仍没有找到，可以略过此步）<br />\r\n<img src="pic/utorrent_settings_7.png" alt="ratio" /><br /><br />\r\n\r\n7.<font color=red>(重要)</font> “高级”设置中，修改 net.disable_incoming_ipv6 为 false ，如图：<br />\r\n（某些版本的μTorrent可能没有此设置，如果仔细检查仍没有找到，可以略过此步）<br />\r\n<img src="pic/utorrent_settings_8.png" alt="ratio" /><br /><br />\r\n\r\n8.进行缓存设置,防止因为磁盘负荷降低下载速度：<br />\r\n请注意μTorrent是否提示“磁盘负荷过重”：<br />\r\n<img src="pic/disk_overloaded.png" alt="ratio" /><br /><br />\r\n\r\n若出现“磁盘负荷过重”提示，建议更改缓存设置：<br />\r\n<br />\r\n<img src="pic/cache_settings.png" alt="ratio" /><br />\r\n<br />', 1, 1, 3),
...
(3, '西农开源社区', 'http://www.xnlinux.cn', '西农学生linux爱好者论坛'),
(4, '麦田pt官方微博', 'http://t.sina.com.cn/mtpt', '麦田pt官方微博');
...
(1, '流量异常监控', 'cheaters.php', '查看流量异常的账户'),
(2, '重复IP地址检测', 'ipcheck.php', '检查IP地址重复的用户'),
(3, '当前在线客户端', 'allagents.php', '查看当前在线（上传/下载/做种）的客户端'),
(4, '广告管理', 'admanage.php', '添加站点广告'),
(5, '发布员状态', 'uploaders.php', '查看发布员当前状态'),
(6, 'Tracker服务器状态', 'stats.php', '查看tracker状态'),
(7, 'IP地址检测', 'testip.php', '检测IP是否被禁止锁定'),
(8, '添加积分', 'amountbonus.php', '为指定用户或组添加积分'),
(9, '清理服务器缓存', 'clearcache.php', '清空memcached的缓存');
...
(2, 'styles/BlueGene/', '蓝色基因', '', 'Zantetsu', 'HDBits clone'),
(3, 'styles/BlasphemyOrange/', '橙色', '', 'Zantetsu', 'Bit-HDTV clone'),
(4, 'styles/Classic/', '经典', '', 'Zantetsu', 'TBSource original mod'),
(6, 'styles/DarkPassion/', '黑色激情', '', 'Zantetsu', ''),
(7, 'styles/BambooGreen/', '竹绿', '', 'Xia Zuojie', 'Baidu Hi clone'),
(8, 'styles/NewYear/', '新年', '', '星星', '西农开源社区');
...
(1, '删除被禁止用户', 'deletedisabled.php', '删除所有被禁止用户'),
(2, '论坛管理', 'forummanage.php', '编辑/删除论坛版块'),
(3, '数据库状态', 'mysql_stats.php', '查看 MySql 状态'),
(4, '全站发邮件', 'massmail.php', '给全站用户发送邮件'),
(5, '重置tracker状态', 'docleanup.php', '清理tracker状态'),
(6, '禁止IP管理', 'bans.php', '设定禁止IP访问'),
(7, '失败登录管理', 'maxlogin.php', '查看密码错误尝试记录，禁止ip或解禁ip'),
(8, '用户头像管理', 'bitbucketlog.php', '管理用户上传头像'),
(9, '禁止邮件域管理', 'bannedemails.php', '限制指定后缀的邮箱不可以注册'),
(10, '允许邮件域管理', 'allowedemails.php', '允许注册的邮件域范围'),
(11, 'IP范围限速', 'location.php', '管理指定IP段的下载上传速度'),
(12, '增加上传量', 'amountupload.php', '给指定用户组增加上传量'),
(13, '删除无用的附件文件', 'delattachments.php', '将无用的附件图片等文件删除，清理服务器磁盘空间，会浪费一定执行时间，请定期而不要频繁清理');
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `notifs` varchar(500) DEFAULT '[cat401][incldead=0]',
  `modcomment` text,
...
INSERT INTO `users` (`id`, `username`, `passhash`, `secret`, `email`, `status`, `added`, `last_login`, `last_access`, `last_home`, `last_offer`, `forum_access`, `last_staffmsg`, `last_pm`, `last_comment`, `last_post`, `last_browse`, `last_music`, `last_catchup`, `editsecret`, `privacy`, `stylesheet`, `caticon`, `fontsize`, `info`, `acceptpms`, `commentpm`, `ip`, `class`, `max_class_once`, `avatar`, `uploaded`, `downloaded`, `seedtime`, `leechtime`, `title`, `country`, `notifs`, `modcomment`, `enabled`, `avatars`, `donor`, `donated`, `donated_cny`, `donoruntil`, `warned`, `warneduntil`, `noad`, `noaduntil`, `torrentsperpage`, `topicsperpage`, `postsperpage`, `clicktopic`, `deletepms`, `savepms`, `showhot`, `showclassic`, `support`, `picker`, `stafffor`, `supportfor`, `pickfor`, `supportlang`, `passkey`, `promotion_link`, `uploadpos`, `forumpost`, `downloadpos`, `clientselect`, `signatures`, `signature`, `lang`, `cheat`, `download`, `upload`, `isp`, `invites`, `invited_by`, `gender`, `vip_added`, `vip_until`, `seedbonus`, `charity`, `bonuscomment`, `parked`, `leechwarn`, `leechwarnuntil`, `lastwarned`, `timeswarned`, `warnedby`, `sbnum`, `sbrefresh`, `hidehb`, `showimdb`, `showdescription`, `showcomment`, `showclienterror`, `showdlnotice`, `tooltip`, `shownfo`, `timetype`, `appendsticky`, `appendnew`, `appendpromotion`, `appendpicked`, `dlicon`, `bmicon`, `showsmalldescr`, `showcomnum`, `showlastcom`, `showlastpost`, `pmnum`, `school`, `showfb`, `cardnum`, `salarynum`, `salary`) VALUES
(1, 'admin', 'c9dca13e8b36ca8fb30f0d813594468a', 'vngjsqufsmnxphvgingg', 'admin@example.com', 'confirmed', '2011-05-27 15:06:52', '2011-05-27 07:04:02', '2011-05-27 09:23:21', '2011-05-27 09:22:26', '2011-05-27 09:22:53', '2011-05-27 09:23:17', '0000-00-00 00:00:00', '2011-05-27 08:00:16', '0000-00-00 00:00:00', '2011-05-27 07:59:46', 1306513392, 0, 0, '', 'normal', 7, 1, 'medium', NULL, 'yes', 'yes', '127.0.0.1', 16, 1, '', 0, 0, 0, 0, '', 8, '[cat401][incldead=0]', NULL, 'yes', 'yes', 'no', '0.00', '0.00', '0000-00-00 00:00:00', 'no', '0000-00-00 00:00:00', 'no', '0000-00-00 00:00:00', 0, 0, 0, 'firstpage', 'yes', 'no', 'yes', 'yes', 'no', 'no', '', '', '', '', '76c9b1317de23335ae185cfe3c360fbf', NULL, 'yes', 'yes', 'yes', 0, 'yes', '', 25, 0, 0, 0, 0, 0, 0, 'Male', 'no', '0000-00-00 00:00:00', '6.00000000', '0.0', NULL, 'no', 'no', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0, 0, 70, 120, 'no', 'yes', 'yes', 'yes', 'no', 1, 'off', 'yes', 'timealive', 'yes', 'yes', 'icon', 'yes', 'yes', 'yes', 'yes', 'yes', 'no', 'no', 10, 35, 'yes', '', 1, '2011-05-27');
